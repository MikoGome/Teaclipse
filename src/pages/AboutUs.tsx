...
export const AboutUs = () => (
  <Section id="about">
    <div className="flex flex-col-reverse lg:flex-row items-center lg:items-start gap-6 lg:gap-24">
      <Boba />
...
const Boba = () => (
  <div className="relative flex-1 lg:basis-0 text-center self-center">
    <figure className="inline-block overflow-hidden [clip-path:ellipse(45%_50%)] rotate-20 min-w-64 max-w-2/5 lg:max-w-full relative -z-15">
